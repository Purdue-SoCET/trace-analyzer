...
llvm::object::OwningBinary<llvm::object::ObjectFile> ObjBuffer::initObj(const char *filename) {
...
llvm::object::ELF32LEFile ObjBuffer::initElf(llvm::StringRef ref, const char *filename) {
...
llvm::object::ELF32LEFile::Elf_Shdr ObjBuffer::initTextShdr(ELF32LEFile Elf) {
    ...
    auto TextOrNone = std::find_if(Sections.begin(), Sections.end(), [&](auto Shdr) {
